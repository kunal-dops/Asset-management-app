...
async function seed() {
  ...
  const assets = await Asset.insertMany([
    {
      asset_name: "Dell Latitude 5540",  asset_tag: "AST-001", serial_number: "DL5540-SN001",
    ...
    {
      asset_name: "HP EliteBook 840",    asset_tag: "AST-002", serial_number: "HP840-SN002",
    ...
    {
      asset_name: "Lenovo ThinkPad E14", asset_tag: "AST-003", serial_number: "LNVE14-SN003",
    ...
    {
      asset_name: "HP ProDesk 400 G9",   asset_tag: "AST-004", serial_number: "HPD400-SN004",
    ...
    {
      asset_name: "Dell OptiPlex 7010",  asset_tag: "AST-005", serial_number: "DLOP7010-SN005",
    ...
    {
      asset_name: "LG 24\" FHD Monitor", asset_tag: "AST-006", serial_number: "LG24-SN006",
    ...
    {
      asset_name: "Dell 27\" 4K Monitor", asset_tag: "AST-007", serial_number: "DL27-SN007",
    ...
    {
      asset_name: "HP LaserJet Pro M404", asset_tag: "AST-008", serial_number: "HPM404-SN008",
    ...
    {
      asset_name: "Cisco Catalyst 2960",  asset_tag: "AST-009", serial_number: "CISCO2960-SN009",
    ...
    {
      asset_name: "TP-Link WiFi 6 Router", asset_tag: "AST-010", serial_number: "TPWIFI6-SN010",
    ...
    {
      asset_name: "Samsung Galaxy Tab S8", asset_tag: "AST-011", serial_number: "SAMS8-SN011",
    ...
    {
      asset_name: "Dell PowerEdge R740",  asset_tag: "AST-012", serial_number: "DLPE740-SN012",
    ...
    {
      asset_name: "Logitech MK540 Combo", asset_tag: "AST-013", serial_number: null,
    ...
    {
      asset_name: "HP Laptop 15s",        asset_tag: "AST-014", serial_number: "HP15S-SN014",
    ...
    {
      asset_name: "Canon PIXMA G3010",    asset_tag: "AST-015", serial_number: "CANG3010-SN015",
